...
public class GenericGuiHandler implements IGuiHandler {
     ...
     */
    public static boolean openItemGUI(EntityPlayer player, World world,
            ItemStack item) {
        int slot = player.inventory.currentItem;
        if (player.inventory.mainInventory[slot] != item)
            new Exception("Item provided was not found correctly")
                    .printStackTrace();
    ...
    private static Object getGuiElement(int ID, EntityPlayer player, World world,
    ...
    private static Object getItemGuiElement(EntityPlayer player, World world,
            int slot, boolean isClientSide) {
