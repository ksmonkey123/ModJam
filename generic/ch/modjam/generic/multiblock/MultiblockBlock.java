...
public abstract class MultiblockBlock extends BlockContainer {
     ...
     */
    public abstract MultiblockTileEntity getCustomTileEntity(World var1,
            int var2);
     ...
     * @param isActive
     */
    public static void setActivationState(World w, int x, int y, int z,
            boolean isActive) {
     ...
     * @param y
     * @param z
     * @return <tt>true</tt> if the block is registered as active,
