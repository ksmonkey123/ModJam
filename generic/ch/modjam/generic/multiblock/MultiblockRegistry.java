...
public class MultiblockRegistry {
	 ...
	 * 
	 * @param structure
	 * @param te the multiblock's master tile-entity
	 * @return the generated instance id. use this ID for multiblock references
	 */
	public int registerMultiblockInstance(String structure, MultiblockTileEntity te) {
		int id = 0; // TODO: initialize
	...
	/**
	 * register a multiblock structure instance with a predefined key. This is used for world reload
	 * to restore the registry. new instances should never be registered with a preset ID!
	 * 
	 * @param instanceID
	 * @param structure
	 * @param te
	 */
	public void registerMultiblockInstance(int instanceID, String structure, MultiblockTileEntity te) {
		this.activeMultiblocks.put(Integer.valueOf(instanceID), new ActiveSet(structure, te));
