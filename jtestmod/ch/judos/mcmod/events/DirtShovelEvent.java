...
public class DirtShovelEvent extends PlayerEvent {
	/**
	 * This event is fired when a player attempts to use a Hoe on a block, it can be canceled to
	...
	public DirtShovelEvent(EntityPlayer player, ItemStack current, World world, int x, int y, int z) {
		super(player);
