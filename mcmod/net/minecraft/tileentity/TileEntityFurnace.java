...
public class TileEntityFurnace extends TileEntity implements ISidedInventory {
	...
	public void updateEntity() {
		TileEntityHooks.updateEntity(this); // CHANGED
	...
	public void smeltItem() {
		if (this.canSmelt()) {
			...
			if (this.furnaceItemStacks[2] == null) {
				...
				this.furnaceItemStacks[2].stackSize += itemstack.stackSize; // Forge BugFix: Results
																			// may have multiple
																			// items
			}
	...
	public static boolean isItemFuel(ItemStack p_145954_0_) {
		/**
		 * Returns the number of ticks that the supplied fuel item will keep the furnace burning, or
		 * 0 if the item isn't fuel
		 */
	...
	public boolean isUseableByPlayer(EntityPlayer par1EntityPlayer) {
		return this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord) != this ? false : par1EntityPlayer
			.getDistanceSq((double) this.xCoord + 0.5D, (double) this.yCoord + 0.5D,
