...
public class TrekTech {
	...
	public static Block			blockPlasmaValve			= new BlockPlasmaValve("valve1",
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		MultiblockBlock myMBB = (MultiblockBlock) new MultiblockBlock(Material.rock) {
			@Override
		...
		for (int i = 0; i < plasmaTypes.length; i++) {
			...
			// PIPES
			TrekTech.pipes[i][0] = new BlockPlasmaPipe("pipe" + i, plasmaType, plasmaType
				.getRadius());
			TrekTech.pipes[i][1] = new BlockPlasmaPipe("pipe" + i + "c", plasmaType);
			RegistryUtil.registerBlock(TrekTech.pipes[i][0], TileEntityPlasmaPipe.class);
			...
			RegistryUtil.registerBlock(TrekTech.valves[i], TileEntityPlasmaValve.class);
		}
		...
		RegistryUtil.registerBlock(TrekTech.blockPlasmaSource, TileEntityPlasmaSource.class);
		RegistryUtil.registerBlock(TrekTech.blockPlasmaEnergizerLow,
			TileEntityPlasmaEnergizerLow.class);
		RegistryUtil.registerBlock(TrekTech.blockPlasmaFurnace, TileEntityPlasmaFurnace.class);
		// RECIPES
	...
	private static void registerRecipes() {
		...
		GameRegistry.addShapedRecipe(new ItemStack(TrekTech.blockDuraniumWall, 4), "DDD", "DDD",
			'D', new ItemStack(TrekTech.itemDuraniumIngot));
		ItemStack duraniumWallStack = new ItemStack(TrekTech.blockDuraniumWall);
		GameRegistry.addShapelessRecipe(new ItemStack(TrekTech.itemDuraniumIngot, 6),
			duraniumWallStack, duraniumWallStack, duraniumWallStack, duraniumWallStack);
		GameRegistry.addSmelting(Items.redstone, new ItemStack(TrekTech.itemPlasmaContainmentRing,
			1), 0.5F);
		GameRegistry.addShapedRecipe(new ItemStack(TrekTech.pipes[0][0], 6), "III", "CCC", "III",
			'I', new ItemStack(Items.iron_ingot), 'C', new ItemStack(
				TrekTech.itemPlasmaContainmentRing));
		GameRegistry.addShapedRecipe(new ItemStack(TrekTech.pipes[1][0], 6), "PPP", "CCC", "PPP",
			'P', new ItemStack(TrekTech.pipes[0][0]), 'C', new ItemStack(
				TrekTech.itemPlasmaContainmentRing));

		ItemStack duraniumings = new ItemStack(TrekTech.itemDuraniumIngot);
		ItemStack mk1pipestack = new ItemStack(TrekTech.pipes[1][0]);
		ItemStack containments = new ItemStack(TrekTech.itemPlasmaContainmentRing);

		GameRegistry.addShapelessRecipe(new ItemStack(TrekTech.pipes[2][0], 3), duraniumings,
			duraniumings, duraniumings, containments, containments, containments, mk1pipestack,
			mk1pipestack, mk1pipestack);

		ItemStack mk2pipestack = new ItemStack(TrekTech.pipes[2][0]);

		GameRegistry.addShapelessRecipe(new ItemStack(TrekTech.pipes[3][0], 3), duraniumings,
			duraniumings, duraniumings, containments, containments, containments, mk2pipestack,
			mk2pipestack, mk2pipestack);

		TTRegistry.registerAdditionalFurnaceRecipe(Items.ender_pearl, new ItemStack(
			Items.ender_eye, 1));
	}

	@SuppressWarnings("boxing")
	private static void addEncasingRecipe(int pipeID) {
		GameRegistry.addShapedRecipe(new ItemStack(TrekTech.pipes[pipeID][1], 4), " P ", "PDP",
			" P ", 'D', new ItemStack(TrekTech.blockDuraniumWall), 'P', new ItemStack(
				TrekTech.pipes[pipeID][0]));
	}
