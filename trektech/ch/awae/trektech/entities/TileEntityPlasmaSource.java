 ...
 */
public class TileEntityPlasmaSource extends ATileEntityPlasmaSystem implements IInventory, IHasGui {
	...
	public boolean connectsToPlasmaConnection(EnumPlasmaTypes plasma, ForgeDirection direction) {
		return plasma == EnumPlasmaTypes.NEUTRAL && BlockGenericDualStateDirected
			.getFaceDirectionForMeta(EFace.BACK, this.getBlockMetadata()) == direction
			.getOpposite();
	}
