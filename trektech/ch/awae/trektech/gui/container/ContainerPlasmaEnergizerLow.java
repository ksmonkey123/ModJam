 ...
 */
public class ContainerPlasmaEnergizerLow extends Container {
     ...
     * @param te
     */
    public ContainerPlasmaEnergizerLow(InventoryPlayer inventoryPlayer,
            TileEntityPlasmaEnergizerLow te) {
        this.tileEntity = te;
